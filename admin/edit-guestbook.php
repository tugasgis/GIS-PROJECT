...
if (session_is_registered('id'))
{
	...
	//untuk paging
	$query=mysql_db_query($db,"select * from guestbook order by id_gb desc",$koneksi); //input
	...
	if ($jumlah){
		?>
		  ...
		  <table width="471" border=0 align=center cellpadding="5">
		<tr>
		...
		while ($data=mysql_fetch_array($result))
		{
			...
			<td>
			  <div align="center"><a href=delete.php?id=<? echo $data['id_gb']; ?>&type=guest&hal=home.php?page=4 style='text-decoration:none' title="Hapus">
